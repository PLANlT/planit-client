...
class _PlanDataSource implements PlanDataSource {
  ...
  Future<ApiResponse<ArchivingCompletePlanResponseBody>> completePlan({
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<ApiResponse<ArchivingCompletePlanResponseBody>>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/planit/plans/${planId}/complete',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<ArchivingCompletePlanResponseBody> _value;
    try {
      _value = ApiResponse<ArchivingCompletePlanResponseBody>.fromJson(
        _result.data!,
        (json) => ArchivingCompletePlanResponseBody.fromJson(
